...
public class BiomeAPI {
    ...
    public FiguraVec3 getSkyColor() {
        return FiguraVec3.fromVec3f(biome.getAttributes().applyModifier(EnvironmentAttributes.SKY_COLOR, new Vector3f(0, 0, 0)));
    }
    ...
    public FiguraVec3 getFogColor() {
        return FiguraVec3.fromVec3f(biome.getAttributes().applyModifier(EnvironmentAttributes.FOG_COLOR, new Vector3f(0, 0, 0)));
    }
    ...
    public FiguraVec3 getWaterFogColor() {
        return FiguraVec3.fromVec3f(biome.getAttributes().applyModifier(EnvironmentAttributes.WATER_FOG_COLOR, new Vector3f(0, 0, 0)));
    }
